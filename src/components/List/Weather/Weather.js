...
class Weather extends React.Component {
    ...
    async componentDidMount() {
        await fetch("https://cors-anywhere.herokuapp.com/https://api.openweathermap.org/data/2.5/weather?q=New York,us&appid=70439c79cebf51416398a33b121030b1&units=imperial")
            .then(res => res.json())
            .then(
                (result) => {
                    console.log(result);
